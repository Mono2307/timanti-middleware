        ...
        <tr><td>
          <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e0e0e0; border-radius:8px; background:#f9f9f9;">
            <tr><td style="padding:20px;">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="font-size:13px; color:#666666; padding:5px 0;">Voucher</td>
                ...
                <tr><td colspan="2" style="border-top:1px solid #dddddd; padding-top:4px;"></td></tr>
                <tr>
                  <td style="font-size:14px; color:#006630; font-weight:bold; padding:5px 0;">Voucher Value</td>
...
// Exchange Note confirmation. Unlike a voucher there is no code to redeem and no expiry — the
// trade-in value has already been deducted from a specific new invoice.
function buildExchangeNoteHtml({ customerName, excNumber, excValue, oldOrder, newOrder }) {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
...
<body style="background:#f4f4f4; padding:20px 0;">
  <table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px; margin:0 auto; background:#ffffff; border-radius:8px; overflow:hidden;">
    <tr><td>
      ...
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr><td style="padding:28px 30px 10px 30px; text-align:center;">
          ${oldOrder ? `<p style="font-size:13px; color:#999999; margin-bottom:8px;">Exchanged Item — Order ${oldOrder}</p>` : ''}
          <h2 style="font-size:22px; color:#000000; margin-bottom:16px;">Your Exchange Note</h2>
          <p style="font-size:14px; color:#444444; line-height:1.6;">Hi <strong>${customerName}</strong>, your exchange has been applied directly to your new purchase. No action is needed.</p>
        </td></tr>
      </table>
        ...
        <tr><td>
          <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e0e0e0; border-radius:8px; background:#f9f9f9;">
            <tr><td style="padding:20px;">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="font-size:13px; color:#666666; padding:5px 0;">Exchange Note</td>
                  <td style="font-size:14px; color:#000000; font-weight:bold; text-align:right; padding:5px 0; letter-spacing:1px;">${excNumber}</td>
                </tr>
                ${newOrder ? `<tr>
                  <td style="font-size:13px; color:#666666; padding:5px 0;">Applied to</td>
                  <td style="font-size:14px; color:#000000; font-weight:bold; text-align:right; padding:5px 0; letter-spacing:1px;">${newOrder}</td>
                </tr>` : ''}
                <tr><td colspan="2" style="border-top:1px solid #dddddd; padding-top:4px;"></td></tr>
                <tr>
                  <td style="font-size:14px; color:#006630; font-weight:bold; padding:5px 0;">Exchange Value Deducted</td>
                  <td style="font-size:14px; color:#006630; font-weight:bold; text-align:right; padding:5px 0;">Rs.${excValue}</td>
                </tr>
              </table>
            </td></tr>
          </table>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="padding:10px 30px 20px 30px;">
        <tr><td style="background:#fff8f0; border:1px solid #f5d9b8; border-radius:6px; padding:14px 18px; font-size:12px; color:#666666; text-align:center;">
          This exchange value has already been deducted from your new invoice. It is not a credit for future use.
        </td></tr>
      </table>

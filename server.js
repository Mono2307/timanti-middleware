...
// Serialization routes live in src/modules/serialization/routes.js. SERIAL_DEPS comes from
// there too — five call sites below allocate or cancel serials outside those routes.
...
const ctx = { config, supabase, getShopifyToken, log };

...
app.get('/api/test-db', async (req, res) => {
  ...
  return res.json({
    ...
    config: {
      ...
      pinePaymentModeValue:   pine.getPinePaymentMode(),
...
app.post('/api/shopify-draft-created', async (req, res) => {
  ...
  try {
    ...
    const terminalTag       = pine.parseTerminalTag(draft.tags);
    ...
    const result = await pine.pushDraftOrderToTerminal({ draftOrderId, draftOrderName, amountInRupees, shopifyLocationId, terminalTag });
